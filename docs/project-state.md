...
| S002 | Density-independent layout: the same apparent size on a 1x desktop and a ~3x phone, with narrow- and short-viewport blocks | verified | `test_screen_is_responsive_on_a_phone_viewport` (2728x1264 px at density 3.0) plus desktop and portrait captures at 1x/2.25x | G001 |
| S012 | The whole screen fits a 19.5:9 handset held sideways (360 dp tall): Start is reachable and the footer is on screen | verified | LF2 captures at 2340x1080 density 3.0 before and after the `max-height: 440dp` block; the progress bar reserves no height there until a copy is running | G001 |
| S013 | Every user-facing string on the screen belongs to the consuming title, including the browse button | verified | `Config.browse_label`, `Config.accepted_message`, title/message/hint/footer; LF2 shows "Choose your game files", Benefactor the plural default | G001 |
