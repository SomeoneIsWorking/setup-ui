...
| S004 | One bounded ZIP stands in for the whole set | verified | Archive case in `tests/test_setup_ui.cpp`; end-to-end ZIP import verified on the shared API 35 emulator | G001 |
